...
// Открываем базу данных (синхронно для простоты)
...
io.on('connection', (socket) => {
    ...
    socket.on('join-ticket', (ticketId) => socket.join(`ticket_${ticketId}`));
    socket.on('leave-ticket', (ticketId) => socket.leave(`ticket_${ticketId}`));
});
